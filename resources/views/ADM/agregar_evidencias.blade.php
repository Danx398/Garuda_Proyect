...
<div class="container">
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-10">
            <form action="{{ route('agregarEvidencia-admin',$datos->id_alumno) }}" class="form-control bg-primary text-light" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="row justify-content-center text-center mt-3">
                    <div class="col-5 pt-2 pb-2">
                        ...
                        <input type="text" class="form-control mt-2" name="nombre_evento">
                        <label for="" class="mt-3">Subir evidencia</label>
                        <input type="file" name="archivo" id="archivo" class="form-control mt-2">
                    </div>
                    <div class="col-1"></div>
                    <div class="col-5">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-6 fs-5">{{$datos->nombre}} {{$datos->paterno}} {{$datos->materno}}</div>
